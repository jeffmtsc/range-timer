...
- **Timer screen**:
  ...
  5. **Repeat** restarts the current string/attempt from the briefing if you need to redo it. **Next →** moves to the next match, pausing on a "Score & Change Targets" screen where the course of fire calls for one.
